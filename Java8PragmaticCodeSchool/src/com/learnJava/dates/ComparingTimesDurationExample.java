...
public class ComparingTimesDurationExample {
	...
	public static void main(String[] args) {
		...
		LocalDateTime localDateTime1 = LocalDateTime.of(2022, 8, 19, 23, 59);
		Duration duration3 = Duration.between(localDateTime, localDateTime1);
		System.out.println("duration3 :- " + duration3.toDays());
		...
		System.out.println("duration4:- " + duration4.toDays());
	}
}
