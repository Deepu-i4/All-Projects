...
public class StudentDataBase {
	...
	public static Supplier<Student> studentSupplier = () -> {
		return new Student("Adam", 4, 3.6, "male", Arrays.asList("swimming", "basketball", "volleyball"));
	};

	public static Optional<Student> getOptionalStudent() {
		Student student = new Student("Pushpendra", 2, 4.0, "male", Arrays.asList("swimming", "basketball", "volleyball"));
		Bike bike = new Bike("CBR250", "CBR250");
	...
	public static List<Student> getAllStudents() {
		...
		Student student4 = new Student("Davel", 3, 4.0, "male", 15, Arrays.asList("swimming", "gymnastics", "soccer"));
		/**
		 * 4th grade students
		 */
