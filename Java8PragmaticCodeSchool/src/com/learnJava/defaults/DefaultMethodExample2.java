...
public class DefaultMethodExample2 {
	...
	public static void sortByGPA(List<Student> studentList) {
		Comparator<Student> nullLastComparator = Comparator.nullsLast(gpaComparator);
		studentList.sort(nullLastComparator);
	...
	public static void sortByGender() {
		...
		Comparator<Student> nullLastComparator = Comparator.nullsLast(genderComparator);
		studentList.sort(nullLastComparator);
	...
	public static void comparatorChaining() {
		List<Student> studentList = StudentDataBase.getAllStudents();
		Comparator<Student> nullLastComparator = Comparator.nullsLast(nameComparator.thenComparing(gradeComparator));
		studentList.sort(nullLastComparator);
