...
public class HashMapDemo {
	public static void main(String[] args) {
		...
		System.out.println("keySet:-" + marks.keySet());
		// this will return the set of keys present in hash map

		System.out.println("entrySet:- " + marks.entrySet());
		...
		// assign value 1 to key 'hello' only if specified key 'hello' is absent in hash
		// map
