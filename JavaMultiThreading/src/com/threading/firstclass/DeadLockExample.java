 ...
 * Solution -
 * 
 * Lock sequencing is one possible solution for deadlock avoidance. Adjust the
 * lock sequence for Writer2
 * 
 * @author Deepu Verma
 *
 */
...
class Writer2 extends Thread {
	...
	public void run() {
		...
		//solution
		/*
		 * synchronized (pen) { try { Thread.sleep(10); } catch (Exception e) { }
		 * synchronized (book) { System.out.println("Writer2 writing"); } }
		 */
	}
}
