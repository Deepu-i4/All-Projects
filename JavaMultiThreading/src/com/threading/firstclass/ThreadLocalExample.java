...
public class ThreadLocalExample {
	...
	public static void main(String[] args) {
		String request1 = "Pushpendra";
		String request2 = "Salma";
...
class UserContext {
	private static ThreadLocal<String> userInfoThreadLocal = new ThreadLocal<String>() {
...
class Service1 {
	...
	public void doService1() {
		System.out
				.println("Performing service1 for user - " + UserContext.getUserName() + " " + Thread.currentThread());
	}
}
...
class Service2 {
	...
	public void doService2() {
		System.out
				.println("Performing service2 for user - " + UserContext.getUserName() + " " + Thread.currentThread());
	}
}
