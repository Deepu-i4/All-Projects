package com.threading.secondclass.tuts9.threads.scheduling;
...
import com.threading.secondclass.common.ScheduledTaskA;
import com.threading.secondclass.utils.TimeUtils;
...
public class SchedulingTasksForOneTimeExecution {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("[" + currentThreadName + "] Task-2 scheduled to run after " + delayMillis / 1000
				+ " seconds INITIAL-DELAY i.e. at: " + dateFormatter.format(new Date(task2.scheduledExecutionTime())));
		...
		System.out.println("[" + currentThreadName + "] Task-3 scheduled to run after " + delayMillis2 / 1000
				+ " seconds INITIAL-DELAY i.e. at: " + dateFormatter.format(new Date(task3.scheduledExecutionTime())));
