...
public class SchedulingTasksForFixedDelayRepeatedExecutions {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("[" + currentThreadName + "] Task-1 first-run scheduled for "
				...
				+ TimeUtils.convertToFractionalSecondsStr(0, intervalMillis));
		...
		System.out.println("[" + currentThreadName + "] Task-2 first-run scheduled "
				+ TimeUtils.convertToFractionalSecondsStr(0, delayMillis) + " after "
				+ dateFormatter.format(currentTime) + " and then repeatedly at an interval of every "
				+ TimeUtils.convertToFractionalSecondsStr(0, intervalMillis2));
