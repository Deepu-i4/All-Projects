package com.threading.secondclass.tuts9.executors.scheduling;
...
import com.threading.secondclass.common.CalculationTaskD;
import com.threading.secondclass.common.NamedThreadsFactory;
import com.threading.secondclass.common.ScheduledTaskB;
...
public class SchedulingTasksForOneTimeExecutionUsingExecutors {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		ScheduledFuture<Integer> schedFuture2 = execService.schedule(new CalculationTaskD(2, 3, 3000), 6,
				TimeUnit.SECONDS);
		execService.schedule(new ScheduledTaskB(0), 8, TimeUnit.SECONDS);
		ScheduledFuture<Integer> schedFuture4 = execService.schedule(new CalculationTaskD(3, 4, 0), 10,
				TimeUnit.SECONDS);
