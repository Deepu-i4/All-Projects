...
public class SchedulingTasksForFixedRateRepeatedExecutionsUsingExecutors {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		ScheduledFuture<?> schedFuture1 = execService.scheduleAtFixedRate(new ScheduledTaskB(1000), 4, 2,
				TimeUnit.SECONDS);
		ScheduledFuture<?> schedFuture2 = execService.scheduleAtFixedRate(new ScheduledTaskB(3000), 4, 2,
				TimeUnit.SECONDS);
